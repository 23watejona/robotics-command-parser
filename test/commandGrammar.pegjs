...
f'function' = first:(ensurePreload/outtakePiece/pickupPiece) t:timeout?
{
	return first + (t != null ? t : "")
}
ensurePreload = newline "ensurePreload"
{
	return "getEnsurePreloadCommand()"
}
outtakePiece = newline "outtakePiece"
{
	return "getOuttakePieceCommand()"
}
pickupPiece = newline "pickupPiece"
{
